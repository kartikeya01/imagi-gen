    ...
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w-[800px]">
          Create images generated by ImagiGen using DALL-E AI
        </p>
      </div>
      <form action="" className="mt-16 max-2-3xl" onSubmit={handleSubmit}>
          ...
          <div className="relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify center items-center">
            {form.photo ? (
              <img
                src={form.photo}
                alt={form.prompt}
                className="w-full h-full boject-contain"
              />
            ) : (
              <img
                src={preview}
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666375] text-[16px]">
